...
class Contacts:
    ...
    def multi_DNA_hbonds_plots(self, outputs_dir, start_df):
        ...
        plt.ylabel(r"$N_{HB}$")
        plt.legend(bbox_to_anchor=(1.0, 1.0), loc='upper left')
        plt.savefig('{0}\{1}'.format(str(output_dir), 'Multi-system Protein-DNA_hbonds.tiff'), bbox_inches='tight', dpi=900)
    ...
    def ionic_dna_plot(self, systems, outputs_dir, start_fr):
        ...
        plt.savefig('{0}\{1}{2}'.format(outputs_dir, 'Multi-system Protein-DNA Ionic Interactions', '.tiff'), bbox_inches='tight', dpi=900)
